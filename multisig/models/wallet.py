...
class Signer(models.Model):
    ...
    wallet_descriptor_wrapped_dek = models.TextField(help_text="The AESGCM256 symmetric key created by coordinator. The key is the data encryption key of the wallet_descriptor. This key is then encrypted(wrapped) using ECIES with this signer's XPub public key", null=True, blank=True)
