...
class AdvanceSubscriptionViewSet(viewsets.GenericViewSet):
    ...
    @swagger_auto_schema(responses={200: serializers.AdvanceSubscriptionResponseSerializer(many=True)})
    def create(self, request, *args, **kwargs):
        ...
        - Requires sequential indices starting from a base index
        ...
        Returns a list of responses for each address pair indicating success/skip/error.
        """
        ...
        for address_set in address_sets:
            ...
            receiving_addr = address_set["addresses"]["receiving"]
            change_addr = address_set["addresses"]["change"]
            ...
            if receiving_is_regular or change_is_regular:
                LOGGER.info(
                    f"Skipping advance subscription for index {address_set['address_index']}: "
            ...
            # Subscribe with advance_subscription=True
            try:
                ...
                LOGGER.error(f"Error in advance subscription: {str(e)}", exc_info=True)
