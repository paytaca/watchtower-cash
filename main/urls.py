...
main_urls += [
    ...
    re_path(r"^balance/bch/(?P<tokenaddress>[\w+:]+)/fungible/$", views.Balance.as_view(),name='bch-fungible-balances'),
    re_path(r"^balance/bch/(?P<tokenaddress>[\w+:]+)/fungible/(?P<tokenid>[\w+]+)/$", views.Balance.as_view(),name='bch-fungible-balance'),
