...
main_urls += [
    ...
    re_path(r"^balance/ct/(?P<tokenaddress>[\w+:]+)/fungible/$", views.Balance.as_view(),name='ct-fungible-balances'),
    re_path(r"^balance/ct/(?P<tokenaddress>[\w+:]+)/fungible/(?P<tokenid>[\w+]+)/$", views.Balance.as_view(),name='ct-fungible-balance'),
